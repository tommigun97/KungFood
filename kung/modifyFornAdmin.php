...
<div class="w3-main" style="margin-left:250px">
  ...
  <div  id="fornView" class="w3-content" >
  <section class="w3-center">
  <div class="w3-display-content " style="max-width:600px">

    </div>


      <div class="w3-section">
        <form class="w3-container" method="post" action="./adminModificaFornitore.php">
        <input type="file" class="w3-input w3-margin-bottom w3-round-xxlarge" name="fileToUpload" value="Select Image" id="fileToUpload">
        ...
        <input class="w3-input w3-border w3-margin-bottom w3-round-xxlarge" type="text" value="<?php echo $user_id?>" name="username"  readonly>
        ...
        <div class="w3-container w3-border-top w3-padding-16">
          <button type="submit" value="Upload Image" class="w3-button w3-round-xxlarge w3-left w3-green">Confirm</button>
